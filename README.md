...
The main terminal interaction, prompting the user for their desired metric to visualize.
<img width="557" height="256" alt="{7D0C1540-B8F6-432A-98DA-DFD4E7C4078E}" src="https://github.com/user-attachments/assets/bddabbb7-afe3-4465-a6e6-f00b9669a3fd" />

An example of the temperature metric being visualized, with the bar graph on top and scatter plot below it.
<img width="1434" height="1076" alt="{5373003C-015B-4D9F-BBCC-B5A9CC717305}" src="https://github.com/user-attachments/assets/e60a3bfd-b801-4e68-bea7-ead4246ff183" />
